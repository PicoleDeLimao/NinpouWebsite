					...
					switch(cmd) {
						...
						case 'missions': 
							if (args[0] == 'titles') {
								...
								var response = 	'```md\n' + 
												'[     -] [D-Rank] < !mission rank-chunnin >     : Play over <10> games, have more than <50> average points and play a balanced game today with over <15> kills and less than <8> deaths\n\n' + 
												'[     -] [C-Rank] < !mission rank-tokubetsu >   : Play over <25> games, have more than <75> average points and play a balanced game today with over <20> kills and less than <8> deaths\n\n' + 
												'[     -] [B-Rank] < !mission rank-jounin >      : Play over <35> games, have more than <100> average points and play a balanced game today with over <25> kills and less than <8> deaths\n\n' + 
												'[     -] [A-Rank] < !mission rank-anbu >        : Play over <50> games, have more than <150> average points and play a balanced game today with over <35> kills and less than <8> deaths\n\n' + 
