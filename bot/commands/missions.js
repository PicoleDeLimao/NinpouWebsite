...
var missions = {
	...
	'rob'      : '[ Daily] [D-Rank] < !mission rob > <user>      : You have <50%> chance to rob <min(10% your gold, 10% user gold)> from someone of enemy village or lose it to him\n',
	'play'     : '[     -] [D-Rank] < !mission play >            : Play a game be rewarded with <50g> and <10%> xp\n',
	'win'      : '[     -] [C-Rank] < !mission win >             : Win a game be rewarded with <200g> and <20%> xp\n',
	...
	'win2'     : '[ Daily] [A-Rank] < !mission win2 >            : Win <2> balanced games in a row and be rewarded with <1000g> and <20%> xp\n',
	'win3'     : '[ Daily] [A-Rank] < !mission win3 >            : Win <3> balanced games in a row and be rewarded with <2000g> and <20%> xp\n',
	'win4'     : '[ Daily] [A-Rank] < !mission win4 >            : Win <4> balanced games in a row and be rewarded with <8000g> and <20%> xp\n',
	'win5'     : '[ Daily] [A-Rank] < !mission win5 >            : Win <5> balanced games in a row and be rewarded with <32000g> and <20%> xp\n',
