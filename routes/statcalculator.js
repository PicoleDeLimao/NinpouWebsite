...
async function getHeroStat(name, period, numPlayers) {
	period = period || 3;
	...
	return { stats: stats, bestPlayers: newGamesAggregated.slice(0, numPlayers || 5), numPlayers: newGamesAggregated.length };
};
